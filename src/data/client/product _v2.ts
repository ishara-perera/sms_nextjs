...
export const productClient_v2 = {
  ...crudFactory_v2<Product, QueryOptions, CreateProduct>(API_ENDPOINTS.PRODUCTS_v2),
  get({ slug, language }: GetParams) {
    return HttpClient_v2.get<Product>(`${API_ENDPOINTS.PRODUCTS_v2}/${slug}`, {
      language,
